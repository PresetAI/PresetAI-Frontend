    ...
    <div className="relative -z-10 mt-32 px-6 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-center">
        ...
        <div className="mt-10 flex items-center justify-center gap-x-6">
          <a
            href="#"
            className="rounded-xl bg-indigo-600/90 px-4 py-4 text-sm font-semibold text-white shadow-xl hover:bg-indigo-500/90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
          >
            Get started
          </a>
